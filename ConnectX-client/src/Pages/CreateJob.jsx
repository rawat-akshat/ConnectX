      ...
      <div className="bg-[#FAFAFA] py-10 px-4 lg:px-16">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <textarea  className="w-full pl-3 py-1.5 focus:outline-none placeholder:text-gray-700"
           rows={6}
           defaultValue={"this company is an IT-based company looking forward for software engineers having great problem-solving skills and can team up and communicate to solve real-world problems."}
