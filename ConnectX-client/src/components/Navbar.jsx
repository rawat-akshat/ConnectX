...
import { AuthContext } from "../context/AuthProvider"; //..................extra
...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { path: "/my-job", title: "My Connects" },
    { path: "/salary", title: "Salary Estimate" },
    { path: "/post-job", title: "Post A Connect" },
  ];
  return (
    <header className="max-w-screen-2xl container mx-auto xl:px-24 px-4">
      <nav className="flex justify-between items-center py-6">
        <a href="/" className="flex items-center gap-2 text-2xl ">  {/* removed text-black/.............................. */}
          <svg
        ...
        <ul>
          {navItems.map(({ path, title }) => (
            <li key={path} className="text-base text-white first:text-white py-1">
              <NavLink
                onClick={handleMenuToggler} // ....................................extra.................
                to={path}
                className={({ isActive }) => (isActive ? "active" : "")}
              >
                {title}
